...
import com.techyourchance.coroutines.solutions.exercise4.Exercise4SolutionFragment
...
import com.techyourchance.coroutines.solutions.exercise8.Exercise8SolutionFragment
import com.techyourchance.coroutines.solutions.exercise9.Exercise9SolutionFragment
...
class ScreensNavigator(private val fragNavController: FragNavController) {
	...
	fun toExercise4Solution() {
		fragNavController.pushFragment(Exercise4SolutionFragment.newInstance())
	}
	...
	fun toExercise8Solution() {
		fragNavController.pushFragment(Exercise8SolutionFragment.newInstance())
	}
	...
	fun toExercise9Solution() {
		fragNavController.pushFragment(Exercise9SolutionFragment.newInstance())
	}
	...
	fun toExercise10Solution() {
		fragNavController.pushFragment(Exercise10SolutionFragment.newInstance())
	}
}
